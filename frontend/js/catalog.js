window.OrganicStoreCatalog = [
  ...
  },
  {
    ...
    price: 30,
    category: 'Vegetables',
    image: '../assets/products/farm-potato.jpg',
    stock: 72,
    description: 'Fresh potatoes for curries, roasting, and home meals.',
    unit: 'kg'
  },
  {
    id: 'prod-017',
    ...
    stock: 66,
    description: 'Crisp red onions for everyday cooking and salads.',
    unit: 'kg'
  },
  {
    id: 'prod-018',
    ...
    price: 180,
    category: 'Pantry',
    image: '../assets/products/garlic-cloves.jpg',
    stock: 34,
    description: 'Fragrant garlic cloves packed for seasoning and cooking.',
    unit: '200g pack'
  },
  {
    id: 'prod-019',
    ...
    price: 60,
    category: 'Fruits',
    image: '../assets/products/lemon.jpg',
    stock: 52,
    description: 'Bright lemons for drinks, dressings, and cooking.',
    unit: 'kg'
  },
  {
    id: 'prod-020',
    ...
    price: 55,
    category: 'Dairy',
    image: '../assets/products/local-yogurt.jpg',
    stock: 40,
    description: 'Fresh yogurt made locally for meals and snacks.',
    unit: 'cup'
  },
  {
    id: 'prod-021',
    ...
    stock: 28,
    description: 'Soft paneer blocks for simple home cooking.',
    unit: '200g pack'
  }
];
